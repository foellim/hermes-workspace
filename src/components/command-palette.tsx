  ...
  const screenActions = useMemo<Array<CommandAction>>(
    () => [
      ...
      },
      {
        ...
        group: 'Screens',
        label: 'Cockpit',
        keywords: 'milleo executive strategy projects files overview',
        shortcut: 'Go',
        icon: Building01Icon,
        onSelect: () => void navigate({ to: '/cockpit' }),
      },
      {
        id: 'screen-curation',
        group: 'Screens',
        label: 'File Curation',
        keywords: 'milleo classify index project files curation',
        shortcut: 'Go',
        icon: File01Icon,
        onSelect: () => void navigate({ to: '/curation' }),
      },
      {
